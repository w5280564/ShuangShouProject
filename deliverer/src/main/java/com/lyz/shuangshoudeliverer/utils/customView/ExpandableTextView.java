package com.lyz.shuangshoudeliverer.utils.customView;
...
public class ExpandableTextView extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        id_source_textview = (TextView) findViewById(R.id.tvContentInforItem);
        id_expand_textview = (TextView) findViewById(R.id.tvPackUpInforItem);
