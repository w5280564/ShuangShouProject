...
import com.lyz.shuangshouproject.ui.bean.LocationBean;
import com.lyz.shuangshouproject.ui.bean.OrderDetailBean;
import com.lyz.shuangshouproject.ui.bean.OrderListBean;
import com.lyz.shuangshouproject.ui.bean.PointBean;
...
public interface UrlApi {
    ...
    @POST("user/reg")
    Observable<UserAccountBean> register(@Field("username") String username, @Field("pwd") String pwd, @Field("state") String state);
