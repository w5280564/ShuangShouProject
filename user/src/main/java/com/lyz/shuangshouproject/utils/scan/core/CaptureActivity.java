package com.lyz.shuangshouproject.utils.scan.core;
...
import com.lyz.shuangshouproject.ui.activity.NewAddOrderActivity;
import com.lyz.shuangshouproject.utils.scan.camera.CameraManager;
import com.lyz.shuangshouproject.utils.scan.executor.ResultHandler;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
	...
	public void handleDecode(Result rawResult, Bitmap barcode) {
		...
		if (barcode == null) {
			...
			//扫描出结果，跳转到新增订单
			Intent intent = new Intent(CaptureActivity.this, NewAddOrderActivity.class);
			intent.putExtra("cartonId",resultHandler.getDisplayContents().toString());
